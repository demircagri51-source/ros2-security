...
print(f"🔍 [BASELINE] Standart Donanim Yuku (CPU/RAM) Olculuyor...")
...
plt.plot(timestamps, cpu_data, label='CPU Kullanim (%)', color='gray', linewidth=2)
plt.plot(timestamps, ram_data, label='RAM Kullanim (%)', color='blue', linewidth=2)

plt.title('Standart Sistem Kaynak Kullanimi (Baseline)', fontsize=14, fontweight='bold')
...
save_path = os.path.expanduser('~/a9_ws/docs/cpu_ram_baseline_plot.png')
plt.savefig(save_path, dpi=300)
print(f"\n📈 Baseline CPU/RAM Grafigi kaydedildi: {save_path}")
